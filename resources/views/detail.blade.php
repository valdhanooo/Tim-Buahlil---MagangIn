...
@section('title', 'UI/UX Designer Intern - MagangIn')
...
<section class="pt-12 pb-16 px-6 md:px-12" style="background: linear-gradient(to right, #10367D, #4A88C9);">
    <div class="w-full max-w-6xl mx-auto flex items-center space-x-6">
        <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center p-1.5 shadow-lg flex-shrink-0">
            <img src="https://i.pravatar.cc/150?img=5" alt="TechCorp Logo" class="w-full h-full rounded-full object-cover">
        </div>
        <div>
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tight">UI/UX Designer Intern</h1>
            <p class="text-blue-100 text-lg">TechCorp Indonesia</p>
        </div>
    </div>
</section>
    ...
    <div class="bg-white rounded-2xl shadow border border-gray-100 py-5 px-6 md:px-10 flex flex-col md:flex-row items-start md:items-center justify-between mt-8 w-full gap-6 md:gap-0">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-16">
            <div>
                ...
                <div class="text-xs font-bold py-1.5 px-4 rounded-full flex items-center w-fit" style="background-color: #EAF5E5; color: #4CAF50;">
        ...
        <div>
            <a href="{{ url('/lowongan') }}" class="inline-flex items-center px-5 py-2.5 text-sm font-semibold text-gray-600 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition shadow-sm">
        ...
        <div class="w-full lg:w-2/3 space-y-10 lg:pr-12">
            <div>
                ...
                <p class="text-gray-800 leading-relaxed text-justify" style="font-size: 15px;">
                    TechCorp Indonesia mencari UI/UX Designer Intern yang kreatif dan bersemangat untuk bergabung dalam tim produk kami. Kamu akan terlibat dalam seluruh proses desain dari riset pengguna hingga prototyping.
                </p>
            </div>
