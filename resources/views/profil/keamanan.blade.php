        ...
        <aside class="w-full md:w-1/3 flex flex-col gap-6">
           <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center flex flex-col items-center">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
                ...
                <a href="{{ route('profil.keamanan') }}" class="flex items-center px-6 py-4 border-b border-gray-200 bg-blue-50/30 border-l-4 border-l-[#10367D]">
                    <svg class="w-5 h-5 text-[#10367D] mr-4 -ml-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
